                                                ...
                                                {images.map(
                                                    (
                                                        ...
                                                        <div
                                                            key={`${
                                                                image.preview
                                                            }-${image.lastUpdated?.getTime()}`} // Better key combining URL + timestamp
                                                            className="relative group bg-slate-50 dark:bg-slate-700 rounded-lg overflow-hidden"
                                                        >
                                                            <img
                                                                src={
                                                                    image.preview
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
                                            Let our AI help you create
                                            compelling product listings that
                                            convert better and save you time.
                                        </p>
