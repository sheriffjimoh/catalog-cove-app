...
export default function MediaManager({
    ...
    const deleteImage = (productId: string, imageId: string) => {
        router.delete(route("image.delete", imageId), {
            preserveScroll: true,
            onSuccess: (page) => {
                const success = (page.props?.flash as { success?: boolean })
                    ?.success;
            ...
            <div className="min-h-screen bg-slate-50   dark:bg-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-white dark:dark:bg-slate-900  rounded-xl p-6 border border-slate-200 dark:border-slate-700">
                    ...
                    <div className="space-y-4">
                        {filteredProducts.map((product) => {
                            ...
                            return (
                                <div
                                    key={product.id}
                                    className="bg-white dark:dark:bg-slate-900  rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden"
                                >
                                    {/* Product Header */}
                                    <button
                                        onClick={() =>
                        ...
                        {filteredProducts.length === 0 && (
                            <div className="text-center py-12">
                                <div className="inline-flex items-center justify-center w-16 h-16 bg-slate-100 dark:dark:bg-slate-900  rounded-full mb-4">
                                    <Image
